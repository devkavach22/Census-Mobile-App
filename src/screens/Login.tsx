...
const Login = () => {
    const { setIsLoggedIn, setUserRole } =
    ...
    const handleLogin = async () => {
        ...
        /* ✅ CONVERT UI ROLE → SYSTEM ROLE */

        const systemRole =
            ROLE_MAP[selectedRole];
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.leftPanel}>
                    <View style={{ marginTop: 20 }}>
                        ...
                        <RoleItem title="Enumerator" subtitle="Field Data Collection" icon="user" />
                        <RoleItem title="District Admin" subtitle="Admin Dashboard" icon="home" />
                        <RoleItem title="Super Admin" subtitle="State / National" icon="globe" />
                    </View>
